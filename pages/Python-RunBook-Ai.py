...
st.caption("🚀 Blue-runBook for python code generation powered by OpenAI LLM")
if "messages" not in st.session_state:
    st.session_state["messages"] = [{"role": "assistant", "content": "How can assist you on python juypter notebook?"}]
...
try:
    ...
    st.error("File already exists in the GitHub repository. Skipping creation.")
