...
with st.sidebar:
    ...
    instructions = ["ansible Playbook code ", "yaml file for openshift", "Create python script", "Create shell script","Yaml file for kubernetes"]
...
base_filename = st.text_input("Base Filename", value=prompt, key="base_filename_input")
